...
public:
    ...
    void description(std::string const&) override;
    void description(std::string&&) noexcept override;

    std::string link() const override;
    void link(std::string const&) override;
    void link(std::string&&) noexcept override;
