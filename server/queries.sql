-- user::resources
select * from get_user_studying_resources() order by subject_id, last_study asc nulls first, incomplete_sections desc, resource_id;
select * from get_editing_resources() order by subject_id, last_study asc nulls first, incomplete_sections desc, resource_id;
